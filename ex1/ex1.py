# -*- coding: utf-8 -*-
"""Copy of week01_pa.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1f8IEdFK3z_zS_G9tYhHtNIIsKyeKBJO3
...
def expand(X):
    ...
    X_expanded = np.append(X_expanded, (X_expanded[:, 0] * X_expanded[:, 1]).reshape(X.shape[0], 1), axis=1)
    X_expanded = np.append(X_expanded, np.ones((X.shape[0], 1)), axis=1)
